...
// 3. lecture par étiquette de composante de transformation (XYZ)
component = v.x;
component = v.y;
component = v.z;

// 4. écriture par étiquette de composante de transformation (XYZ)
v.x = 1.0;
v.y = 2.0;
v.z = 3.0;

// 5. lecture par étiquette de composante de couleur (RGB)
component = v.r;
component = v.g;
component = v.b;

// 6. écriture par étiquette de composante de couleur (RGB)
v.r = 1.0;
v.g = 2.0;
v.b = 3.0;
...
// 9. swizzle par étiquette de composante de transformation (XYZ)
...
// 10. swizzle par étiquette de composante de couleur (RGB)
